  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.logo}>AutoServ</Text>
...
const styles = StyleSheet.create({
  ...
  body: { flex: 2, backgroundColor: Colors.bg, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 28 },
  title: { fontSize: 24, fontWeight: '700', color: Colors.text, marginBottom: 6 },
  desc: { fontSize: 14, color: Colors.muted, marginBottom: 32 },
  btnGoogle: { backgroundColor: '#fff', borderWidth: 1.5, borderColor: Colors.border, borderRadius: 12, padding: 14, alignItems: 'center', marginBottom: 12 },
  btnGoogleText: { fontSize: 15, fontWeight: '600', color: Colors.text },
  btnPrimary: { backgroundColor: Colors.brand2, borderRadius: 12, padding: 14, alignItems: 'center', marginBottom: 12 },
  btnPrimaryText: { fontSize: 15, fontWeight: '600', color: '#fff' },
  btnOutline: { borderWidth: 1.5, borderColor: Colors.brand2, borderRadius: 12, padding: 13, alignItems: 'center', marginBottom: 24 },
  btnOutlineText: { fontSize: 15, fontWeight: '600', color: Colors.brand2 },
  linkAdmin: { textAlign: 'center', color: Colors.muted, fontSize: 13 },
});